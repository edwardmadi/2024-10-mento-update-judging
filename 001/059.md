Calm Burgundy Spider

High

# Missing slippage protection for updateRatioForReward can lead to lower reserve ratio than expected
...
Adding two more articles for reference about the bonding curve and reserve ratio relation:
